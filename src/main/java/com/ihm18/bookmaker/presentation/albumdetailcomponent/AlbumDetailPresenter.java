...
public class AlbumDetailPresenter implements Initializable {
	...
	/**
	 * fx:id=albumCreationDateTextField champ de texte de la date de création de
	 * l'album
	 */
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (albumDetailModel.getAlbum() != null)
			albumCreationDateTextField
					.setText(utility.convertToFrenshDate(albumDetailModel.getAlbum().getDateCreation()));
	}
	...
	public void displayPages(ActionEvent event) {
		...
		centralModel.setMainView(pagesView.getView(),
				utility.replace(PagesView.TITLE, "albumName", albumDetailModel.getAlbum().getName()));
	}
	 ...
	 * @param newValue
	 */
	public void activateApplyChangesButton(ObservableValue<? extends String> observable, String oldValue,
			String newValue) {
	}
	...
	public void applyChanges(ActionEvent event) {
		...
		albumService.edit(albumDetailModel.getAlbum().getId(), albumNameTextField.getText(),
				AlbumDescriptionTextArea.getText());
